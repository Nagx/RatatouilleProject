...
<div class="form-group">
    <label for="VilleduResto">Ville du Restaurant</label>
    <input type="text" class="form-control" id="VilleDuResto" placeholder="Ville du Restaurant" required>
</div>
<div class="form-group">
    <label for="AdresseDuResto">Adresse du Restaurant</label>
    <input type="text" class="form-control" id="AdresseDuResto" placeholder="Adresse du Restaurant">
</div>
<div class="form-group">
    <label for="CodePostalDuResto">Code Postal du Restaurant</label>
    <input type="text" class="form-control" id="CodePostal" placeholder="Code Postal du Restaurant">
</div>
<div class="form-group">
    <label for="VilleduResto">Ville du Restaurant</label>
    <input type="text" class="form-control" id="VilleDuResto" placeholder="Ville du Restaurant">
</div>
<div class="form-group">
    <label for="NombrePlace">Nombre de Places</label>
    <input type="number" class="form-control" id="nbplaceDuResto" placeholder="Nombre de Places">
</div>
<div class="form-group">
    <label for="Surface">Surface du Restaurant (en m2)</label>
    <input type="number" class="form-control" id="surfaceDuResto" placeholder="Surface du Restaurant">
</div>
<div class="form-group">
