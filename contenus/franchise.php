...
<div class="tab-content" id="form_content">
    <div id="tab1" class="tab-pane fade in active">
        <div id="franchise_b">
            ...
            <p class="descriptif">Nos franchisés sont les représentants de notre marque de fabrique et par conséquent un standing de base est nécessaire. Ils doivent donc proposer un menu avec des produits bio et frais et issue d'une fillière locale. Pour cela les premiers temps la qualité des menus sera vérifié ainsi que la propreté des cuisines. Enfin un petit rappel de notre devise chez ratatouille vous aurez les 3 B, du Bio, du Beau et du Bon.</p>
